...
webGroup.add_argument('--host', '-H', type=str, default='0.0.0.0',
                      help='the hostname to listen on (default: 0.0.0.0)')
webGroup.add_argument('--port', '-P', type=int, default=8000,
                      help='the port of the webserver (default: 8000)')
webGroup.add_argument('--ws-interval', type=int, default=15,
                      help='heartbeat interval between discodo server and client (default: 15)')
webGroup.add_argument('--ws-timeout', type=int, default=60,
...
playerGroup.add_argument('--default-volume', type=int,
                         default=100, help="player's default volume (default: 100)")
playerGroup.add_argument('--default-crossfade', type=float, default=10.0,
                         help="player's default crossfade seconds (default: 10.0)")
playerGroup.add_argument('--default-autoplay', type=bool, default=True,
                         help="player's default auto related play state (default: True)")
playerGroup.add_argument('--bufferlimit', type=int, default=5,
                         help='seconds of audio will be loaded in buffer (default: 5)')
playerGroup.add_argument('--preload', type=int, default=10,
                         help='seconds to load next song before this song ends (default: 10)')
playerGroup.add_argument('--timeout', type=int, default=300,
...
logParser.add_argument('--verbose', '-v', action='store_true',
